...
public class HistoryView {
	...
	public void go(){
		...
		ArrayList<String> arrlist = ReaddaorubookList.readdaorubooklist(file);
...
//			System.out.println(arr[6]);
			...
			panelHistory.addMouseListener(new MouseListener() {  
				...
				public void mouseClicked(MouseEvent e) {
					// 一个弹框，此处不细说其语法
					//JOptionPane.showMessageDialog(null, "转到列表", "注意", 0, null);
